  ...
  const d20Mapping = [
  1, 19, 13, 7, 18, 4, 3, 9, 10, 6, 20, 12, 11, 5, 14, 8, 15, 17, 2, 16
];

const d20FaceRotations = [
  { x: 0, y: 0 }, // Placeholder for face 0 (not used)
  { x: 58.2825, y: 0 }, // Face 1
  { x: 58.2825, y: 180 }, // Face 2
  { x: -11.7175, y: -144 }, // Face 3
  { x: -11.7175, y: 144 }, // Face 4
  { x: 58.2825, y: -108 }, // Face 5
  { x: -11.7175, y: 72 }, // Face 6
  { x: 58.2825, y: 108 }, // Face 7
  { x: -11.7175, y: -72 }, // Face 8
  { x: 58.2825, y: 36 }, // Face 9
  { x: 58.2825, y: -36 }, // Face 10
  { x: -11.7175, y: -216 }, // Face 11
  { x: 58.2825, y: 216 }, // Face 12
  { x: -11.7175, y: 0 }, // Face 13
  { x: 58.2825, y: -180 }, // Face 14
  { x: -11.7175, y: 144 }, // Face 15
  { x: 58.2825, y: 108 }, // Face 16
  { x: -11.7175, y: -108 }, // Face 17
  { x: 58.2825, y: -72 }, // Face 18
  { x: 58.2825, y: 72 }, // Face 19
  { x: -11.7175, y: 216 }, // Face 20
];
